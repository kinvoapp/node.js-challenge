...
router.post('/', (0, validation_1.validation)(movementSchema_1.movementSchema.create), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let response = null;
    try {
...
router.delete('/:id', (0, validation_1.validation)(movementSchema_1.movementSchema.deleteById), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let response = null;
    try {
